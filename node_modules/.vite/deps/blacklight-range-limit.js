...
// node_modules/blacklight-range-limit/app/assets/javascripts/blacklight-range-limit/index.js
Chart.register(
  LineController,
  LineElement,
  LinearScale,
...
var BlacklightRangeLimit = class _BlacklightRangeLimit {
  // <canvas> DOM element
  ...
  constructor(container) {
    __publicField(this, "chartEnabled", true);
    __publicField(this, "textualFacets", true);
    __publicField(this, "textualFacetsCollapsible", true);
    __publicField(this, "rangeListHeadingLocalized");
    __publicField(this, "rangeBuckets", []);
    // array of objects with bucket range info
    __publicField(this, "xTicks", []);
    // array of x values to use as chart ticks
    __publicField(this, "lineDataPoints", []);
    // array of objects in Chart.js line chart data format, { x: xVal, y: yVal }
    __publicField(this, "container");
    // div.range-limit wrapping entire facet display box
    __publicField(this, "chartCanvasElement");
  ...
  extractBucketData(facetListDom = this.distributionElement.querySelector(".facet-values")) {
    this.rangeBuckets = Array.from(facetListDom.querySelectorAll("ul.facet-values li")).map((li) => {
      var _a, _b, _c, _d;
      const from2 = this.parseNum(((_a = li.querySelector("span.from")) == null ? void 0 : _a.getAttribute("data-blrl-begin")) || ((_b = li.querySelector("span.single")) == null ? void 0 : _b.getAttribute("data-blrl-single")));
      const to2 = this.parseNum(((_c = li.querySelector("span.to")) == null ? void 0 : _c.getAttribute("data-blrl-end")) || ((_d = li.querySelector("span.single")) == null ? void 0 : _d.getAttribute("data-blrl-single")));
      const count = this.parseNum(li.querySelector("span.facet-count,span.count").textContent);
      const avg = count / (to2 - from2 + 1);
      return {
        from: from2,
        to: to2,
        count,
  ...
  setupDomForChart() {
    ...
    this.chartCanvasElement.setAttribute("aria-hidden", "true");
  ...
  drawChart(chartCanvasElement) {
    ...
    const aspectRatio = ((_a = window.getComputedStyle(wrapper)) == null ? void 0 : _a.getPropertyValue("aspect-ratio")) || 2;
    ...
    new Chart(chartCanvasElement.getContext("2d"), {
      ...
      options: {
        ...
        plugins: {
          ...
          // tooltips don't currently show anything useful for our
        },
        elements: {
        ...
        scales: {
          x: {
            ...
            ticks: {
              ...
              max: maxX,
              autoSkip: true,
              // supposed to skip when can't fit, but does not always work
              maxRotation: 0,
              maxTicksLimit: 5,
              // try a number that should fit
              callback: (val, index2) => {
                return val;
              }
            }
...
export {
  BlacklightRangeLimit as default
};
...
chart.js/dist/chart.js:
   ...
   *)
*/
//# sourceMappingURL=blacklight-range-limit.js.map
